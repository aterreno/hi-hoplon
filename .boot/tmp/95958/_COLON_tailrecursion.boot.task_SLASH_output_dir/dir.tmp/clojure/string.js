...
{{
var G__9326 = cljs.core.pop.call(null,v__$1);
v__$1 = G__9326;
continue;
}
} else
...
{var pred__9330 = cljs.core._EQ_;var expr__9331 = limit;if(cljs.core.truth_(pred__9330.call(null,1,expr__9331)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__9330.call(null,2,expr__9331)))
...
var G__9333 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__9334 = (limit__$1 - 1);
var G__9335 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__9333;
limit__$1 = G__9334;
parts = G__9335;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___9337 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___9337))
{var replacement_9338 = temp__4090__auto___9337;buffer.append([cljs.core.str(replacement_9338)].join(''));
} else
{buffer.append(ch);
}
{
